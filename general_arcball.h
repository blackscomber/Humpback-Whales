...
// Description : GeneralArcball class for mouse manipulation. 	//
//////////////////////////////////////////////////////////////////
...
namespace camera{
	...
	public:
		//Create/Destroy
		GeneralArcBall(float NewWidth, float NewHeight);
		~GeneralArcBall() { /* nothing to do */ };
...
__declspec(selectany) camera::GeneralArcBall    g_gArcBall(640.0f, 480.0f);	// ArcBall Instance
